...
import { TenantsTableDataSource, TenantsTableItem } from './tenants-table-datasource';
...
export class TenantsTableComponent implements AfterViewInit {
  ...
  @ViewChild(MatTable) table!: MatTable<TenantsTableItem>;
  ...
  constructor() {
    this.dataSource = new TenantsTableDataSource();
  }
